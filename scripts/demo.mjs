...
const protocolCore = require(path.join(__dirname, "../packages/protocol/dist/core/index.js"));

const { VirtualRegistry, contentHashFromEnvelope, buildDerivedEnvelope, cidV1FromEnvelope } = protocolCore;
